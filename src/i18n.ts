...
const resources = {
  en: {
    translation: {
      ...
      'deepseek_api_key_help': 'Get your key from platform.deepseek.com',
  ...
  zh: {
    translation: {
      ...
      'deepseek_api_key_placeholder': 'sk-...',
      'deepseek_api_key_help': '从 platform.deepseek.com 获取密钥',
      'deepseek_text_model': '文本模型',
      'active': '当前使用',
      'set_as_active': '设为主要',
      'text_active': '文本：当前使用',
